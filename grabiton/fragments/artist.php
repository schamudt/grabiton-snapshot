...
.artist-id-badge{ position:fixed; left:24px; top:calc(var(--header-h) + 4px); z-index:6; color:#fff; font:600 13px/1.2 ui-monospace; text-shadow:0 2px 6px rgba(0,0,0,.45); }
