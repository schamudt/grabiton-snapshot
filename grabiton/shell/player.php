...
<div class="gio-playerbar solid" hidden>
  <img class="gio-player-cover" src="" alt="Aktuelles Cover" hidden>
     <button class="gio-like gio-likeinline" type="button" aria-label="Like" data-song-id="">
         <span class="gio-like-count">0</span>
           <svg viewBox="0 0 24 24" aria-hidden="true" width="16" height="16">
             <path d="M18 2h-2a1 1 0 0 0-1 1v2H9V3a1 1 0 0 0-1-1H6a1 1 0 0 0-1 1v2H3a1 1 0 0 0-1 1v2a5 5 0 0 0 5 5h1.07A7.01 7.01 0 0 0 11 16.92V19H8a1 1 0 1 0 0 2h8a1 1 0 1 0 0-2h-3v-2.08A7.01 7.01 0 0 0 14.93 13H16a5 5 0 0 0 5-5V6a1 1 0 0 0-1-1h-2V3a1 1 0 0 0-1-1Zm-1 6V6h3v2a3 3 0 0 1-3 3h-1V8ZM6 11a3 3 0 0 1-3-3V6h3v3h1v2H6Z"/>
           </svg>
      </button>
...
<script>
(function(){
  // Passe diese beiden Zeilen bei Bedarf an deine IDs/Klassen an:
  ...
  btn.addEventListener('click', function(ev){
    ...
    // Wenn du bereits eine Next-Funktion hast, nutzen:
    if (typeof window.gioNext === 'function') {
      try { window.gioNext(); return; } catch(e){}
    }

    // Sonst: "Songende" simulieren -> deine Auto-Queue greift
    try {
      audio.pause();
      audio.dispatchEvent(new Event('ended', { bubbles: true }));
    } catch (e) {
      try { audio.currentTime = Math.max(0, (audio.duration || 0) - 0.05); } catch(_) {}
    }
  });
})();
</script>
